...
bmt_data <- left_join(calls_CH, clinical,
  ...
  mutate(sex_pairs2 = case_when(
    sex_pairs == "Female/Female"        ~ "don_Female/rec_Female",
    sex_pairs == "Female/Male"          ~ "sex mismatch",
    sex_pairs == "Male/Female"          ~ "sex mismatch",
    sex_pairs == "Male/Male"            ~ "don_Male/rec_Male"
  ), sex_pairs2 = factor(sex_pairs2,
                        levels = c("don_Male/rec_Male",
                                   "don_Female/rec_Female",
                                   "sex mismatch"
                                   ))) %>% 
  mutate(sex_pairs = case_when(
    sex_pairs == "Female/Female"        ~ "don_Female/rec_Female",
    sex_pairs == "Female/Male"          ~ "don_Female/rec_Male",
    sex_pairs == "Male/Female"          ~ "don_Male/rec_Female",
    sex_pairs == "Male/Male"            ~ "don_Male/rec_Male"
  ), sex_pairs = factor(sex_pairs,
                        levels = c("don_Male/rec_Male",
                                   "don_Female/rec_Female",
                                   "don_Female/rec_Male",
                                   "don_Male/rec_Female"
                                   ))) %>% 
  mutate(race_pairs = case_when(
    race_pairs == "Black/Black"         ~ "don_Black/rec_Black",
    race_pairs == "Other/White"         ~ "don_Other/rec_White",
    race_pairs == "White/Other"         ~ "don_White/rec_Other",
    race_pairs == "White/White"         ~ "don_White/rec_White"
  )) %>% 
  mutate(cmv_pairs = case_when(
    cmv_pairs == "Negative/Negative"    ~ "don_Negative/rec_Negative",
    cmv_pairs == "Negative/Positive"    ~ "don_Negative/rec_Positive",
    cmv_pairs == "Positive/Negative"    ~ "don_Positive/rec_Negative",
    cmv_pairs == "Positive/Positive"    ~ "don_Positive/rec_Positive"
  )) %>% 
  mutate(CH_status = factor(CH_status, 
                            levels = c("No CH", "CH")))
```
...
ggsurvplot(survfit(Surv(os_time, os_event) ~ race, 
                   data = bmt_data),
           title = "OS from bmt", 
           font.main = c(24, "bold", "black"), 
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"), 
...
ggsurvplot(survfit(Surv(os_time, os_event) ~ conditioning_reg, 
                   data = bmt_data),
           title = "OS from bmt", 
           font.main = c(24, "bold", "black"), 
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"), 
...
ggsurvplot(survfit(Surv(relapse_time, relapse_event) ~ rec_cmv_result, 
                   data = bmt_data),
           title = "RFS from bmt", 
           font.main = c(24, "bold", "black"), 
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"), 
...
ggsurvplot(survfit(Surv(relapse_time, relapse_event) ~ don_cmv_res, 
                   data = bmt_data),
           title = "RFS from bmt", 
           font.main = c(24, "bold", "black"), 
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"), 
...
ggsurvplot(survfit(Surv(relapse_time, relapse_event) ~ karnofsky_score, 
                   data = bmt_data),
           title = "RFS from bmt", 
           font.main = c(24, "bold", "black"), 
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"), 
...
ggsurvplot(survfit(Surv(relapse_time, relapse_event) ~ plt20status, 
                   data = bmt_data),
           title = "RFS from bmt", 
           font.main = c(24, "bold", "black"), 
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"), 
...
```{r}
bmt_data %>% 
  select(race_pairs, sex_pairs, sex_pairs2,
         cmv_pairs) %>% 
  tbl_summary()
```
...
ggsurvplot(survfit(Surv(os_time, os_event) ~ sex_pairs2, 
                   data = bmt_data),
           title = "OS from bmt", 
           font.main = c(24, "bold", "black"), 
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"), 
...
ggsurvplot(survfit(Surv(relapse_time, relapse_event) ~ race_pairs, 
                   data = bmt_data),
           title = "RFS from bmt", 
           font.main = c(24, "bold", "black"), 
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"), 
...
ggsurvplot(survfit(Surv(relapse_time, relapse_event) ~ sex_pairs, 
                   data = bmt_data),
           title = "RFS from bmt", 
           font.main = c(24, "bold", "black"), 
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"), 
...
ggsurvplot(survfit(Surv(relapse_time, relapse_event) ~ sex_pairs2, 
                   data = bmt_data),
           title = "RFS from bmt", 
           font.main = c(24, "bold", "black"), 
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"), 
...
ggsurvplot(survfit(Surv(relapse_time, relapse_event) ~ cmv_pairs, 
                   data = bmt_data),
           title = "RFS from bmt", 
           font.main = c(24, "bold", "black"), 
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"), 
...
<div class = "col-md-6">
```{r, fig.height=8}
ggsurvplot(survfit(Surv(os_time, os_event) ~ CH_status, 
                   data = bmt_data),
           title = "OS from bmt", 
           font.main = c(24, "bold", "black"), 
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"), 
...
<div class = "col-md-6">
```{r, fig.height=8}
ggsurvplot(survfit(Surv(relapse_time, relapse_event) ~ CH_status, 
                   data = bmt_data),
           title = "RFS from bmt", 
           font.main = c(24, "bold", "black"), 
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"), 
